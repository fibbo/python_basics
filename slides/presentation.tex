...
print('Combining a string and a number: ' + str(42))
print('Much cleaner way to print string and a number: {}'.format(42))
\end{lstlisting}
...
In order to do mathematical analysis on these numbers, they need to be converted to the appropriate nubmer type first.
...
\subsection{Functions with Return Values: return} % (fold)
...
\usebeamercolor[fg]{normal text}
\bfseries
\begin{frame}[c, fragile]\frametitle{Exercise 12}
Solve exercise 12
\end{frame}
}
